...
import zipfile
with zipfile.ZipFile("SYNDoSpcap.zip","r") as zip_ref:
    zip_ref.extractall()


# File location
path = "SYNDoS_pcap.pcap" #the pcap, pcapng, or tsv file to process.
...
np.savetxt("ssa.csv", RMSEs, delimiter=",")
#np.savetxt("sda.csv", RMSEs, delimiter=",")
